...
from .base import FRBCBaseScenarioTestCase


class FRBCHeatPumpScenarioTestCase(FRBCBaseScenarioTestCase):
    name = "Heat Pump Scenario Test Case"
    ...
    def __init__(
        ...
        # ! TODO : Docs are incomplete on implementing this...

        # self.create_frbc_system_description()
    ...
    # def create_frbc_system_description(self):
    ...
    #         fill_level_range=NumberRange(start_of_range=45, end_of_range=55),
    #     )
    ...
    #         elements=[
    #             FRBCOperationModeElement(
    #                 fill_level_range=NumberRange(start_of_range=0.0, end_of_range=0.0),
    ...
    #                     )
    #                 ],
    #                 running_costs=NumberRange(start_of_range=0, end_of_range=0),
    #             )
    #         ],
    ...
    #         operation_modes=[self.off_operation_mode],
    #         transitions=[
    #             Transition(
    #                 **{
    #                     "id": uuid.uuid4(),
    ...
    #         "Set Initial FRBC System Description",
    ...
    #     self.add_test_method(
    #         "Update FRBC System Description",
    #         self.test_send_frbc_system_description,
    ...
    #     self.add_test_method("Wait for instruction", self.wait_for_instruction)
